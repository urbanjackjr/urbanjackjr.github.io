...
a.restoreOrientation=function(a,h){return a._restoreOrientation(h)};a.restoreOrientationDelayed=function(a,h,e){return a._restoreOrientationDelayed(h,e)};a.saveOrientation=function(a,h){return a._saveOrientation(h)};a.say=function(a){};a.clearConsole=function(a){a._clearConsole()};a.getInfo=function(a){return a._info};a.setInfo=function(a,h,e){a._info=h;2<arguments.length&&a._showInfo(e)};a.showInfo=function(a,h){a._showInfo(h)};a.show2d=function(a,h){a._show2d(h)};a.jmolBr=function(){return a._documentWrite("<br>")};
...
e.indexOf("data: no")?"\nwas not found.\n":"\ncould not be loaded. Script error: "+h.message+" \n\ndata:\n\n"+e)+"\n\n"+a.getStackTrace();throw h;}b.onScriptLoaded(c,!1);ta(d)},ba=function(a){return function(){if("interactive"!=a.readyState){try{a.parentNode&&a.parentNode.removeChild(a)}catch(b){}a=null}}},aa=function(a){window["j2s.script.debugging"]||window.setTimeout(ba(a),1)};a._4Name=function(c,d,e){if(a.isClassDefined(c))return a.evalType(c);d=m._isAsync&&d?d._restoreState(c,
...
b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2021-05-29 22:19:22 -0500 (Sat, 29 May 2021) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.31.41";
